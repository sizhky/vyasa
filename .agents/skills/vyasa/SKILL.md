...
| Write or explain markdown features, including inline task graphs | `references/markdown.md` |
...
5. For recent markdown work, check `references/markdown.md` for Obsidian-style callouts, aliases, nesting/folding, code snippet includes, inline `tasks` fences, and explicit heading IDs/permalinks before inventing new syntax.
