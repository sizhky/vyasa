        ...
        if item.is_dir():
            ...
            if max_depth == 0:
                ...
                if should_expand:
                    ...
                    items.append(Li(Details(_folder_summary(note_link), Ul(*sub_items, cls="ml-4 pl-2 space-y-1 border-l border-slate-100 dark:border-slate-800"), data_folder="true", open=True), cls="my-1"))
                    continue
                ...
                items.append(Li(Details(_folder_summary(note_link, branch_href=branch_href), Ul(cls="ml-4 pl-2 space-y-1 border-l border-slate-100 dark:border-slate-800"), data_folder="true"), cls="my-1"))
                continue
