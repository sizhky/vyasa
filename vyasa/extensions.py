...
def default_preset_selection() -> dict[ExtensionCategory, tuple[str, ...]]:
    return {
        ...
        "render": ("wikilinks", "link_preview", "tabs", "mermaid", "d2", "cytograph", "cryptograph", "tasks", "mdx", "html_viewer", "pdf_viewer", "tree_table", "visuals", "vega", "document_actions", "table_of_contents", "scoped_custom_css", "code_tools", "default_favicon"),
