...
def default_preset_selection() -> dict[ExtensionCategory, tuple[str, ...]]:
    return {
        ...
        "render": ("wikilinks", "tabs", "mermaid", "d2", "cytograph", "cryptograph", "tasks", "pdf_viewer", "tree_table", "document_actions", "table_of_contents", "scoped_custom_css", "code_tools", "default_favicon"),
