...
def navbar_view(blog_title, theme_toggle_node, show_mobile_menus=False, htmx_nav=True, posts_menu_items=None, compact_mode=False, updated_label=None, mobile_extra_controls=(), ref_switcher=None):
    ...
    right = Div(navbar_search_block(""), menu, ref_switcher, theme_toggle_node, *mobile_extra_controls, cls="flex items-center gap-3")
    if compact_mode:
        compact_menu = navbar_panel_toggle("menu", "Toggle library", "window.__vyasaTogglePostsPanel && window.__vyasaTogglePostsPanel()", "posts")
        ...
        row = Div(Div(compact_menu, cls="w-16"), title_block, Div(theme_toggle_node, cls="w-16 flex justify-end"), cls="flex items-center justify-between")
    ...
    if show_mobile_menus:
        ...
        mobile = Div(navbar_panel_toggle("panel-left", "Toggle library", "window.__vyasaTogglePostsPanel && window.__vyasaTogglePostsPanel()", "posts"), mobile_title, Div(navbar_search_trigger(), ref_switcher, theme_toggle_node, *mobile_extra_controls, cls="flex items-center gap-1"), cls="flex items-center justify-between xl:hidden")
