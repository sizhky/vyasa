...
PROJECTION_DISPLAY_KEYS = {
    "default_open_depth", "node-card-width", "filter-panel-width", "node-card-content-scale", "hover-font-size", "color_mix",
...
def normalize_projections(value) -> list[dict]:
    ...
    for raw in value:
        ...
        projection = {
            ...
            "edge_animation_mode": _normalize_string(raw.get("edge_animation_mode")),
            "edge_animation_tick_steps": _normalize_string(raw.get("edge_animation_tick_steps")),
            "edge_animation_tick_duration": _normalize_string(raw.get("edge_animation_tick_duration")),
