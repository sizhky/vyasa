...
Fig. 1 represents the tradesman as you
would see him while you were bending over him from above;
figs. 2 and 3 represent the tradesman, as
...
![A diagram of three triangles, points downwards. They all have the same
width, but the second has a smaller height than the first, and the third
has a smaller height
again.](figures/illustration-1.svg)
