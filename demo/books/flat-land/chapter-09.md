...
side of a circle on the left. The labelled points on the circle are M at
the top, A on the left directly opposite the point of view, B on the
right nearest the point of view, and C and D which describe the visible
